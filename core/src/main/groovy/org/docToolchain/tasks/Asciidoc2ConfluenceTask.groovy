...
class Asciidoc2ConfluenceTask extends DocToolchainTask {
    ...
    static parseAdmonitionBlock(block, String type) {
    ...
    static rewriteDescriptionLists(body) {
    ...
    static getEmbeddedImageData(src) {
    ...
    static promoteHeaders(tree, start, offset) {
        (start..7).each { i ->
